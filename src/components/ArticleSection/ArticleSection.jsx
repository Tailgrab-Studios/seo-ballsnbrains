...
import ballsImg from '../../assets/images/balls.webp';
import ryzeImg from '../../assets/images/ryze1.webp';
import fourImg from '../../assets/images/four.webp';
import everydayDoseImg from '../../assets/images/everyday dose.webp';
import mudImg from '../../assets/images/mud.webp';

const CTA_URL = 'https://lp.vitavaulthealth.com/preclick';
...
function PromoBox() {
  return (
    ...
    >
      ...
      >
        <strong style={{ color: '#d97706' }}>LIMITED TIME PROMO:</strong> 34%
        off + free shipping for new customers if you order right now! Backed by
        a 365-day money-back guarantee — if it doesn't work, they'll return 100%
        of your money.{' '}
        <a
          href={CTA_URL}
          style={{
  ...
  return (
    <div
      style={{
        display: 'flex',
        gap: 12,
        padding: reply ? '14px 0 14px 48px' : '20px 0',
      ...
      <div style={{ flex: 1 }}>
        ...
        >
          <strong
            style={{
              fontFamily: 'sans-serif',
              fontSize: reply ? 13 : 14,
              color: reply ? s.titleColor : '#111',
            }}
          >
            {name}
          </strong>
          <span
            style={{ fontFamily: 'sans-serif', fontSize: 12, color: '#9ca3af' }}
          >
            {time}
          </span>
        </div>
        ...
        >
          {link ? (
            <a
              href={link}
              style={{ color: s.titleColor, textDecoration: 'underline' }}
            >
              {text}
            </a>
          ) : (
      ...
      <div style={{ maxWidth: 740, margin: '0 auto', padding: '0 24px' }}>
        ...
        >
          <p style={{ marginBottom: 16 }}>
            As a die-hard coffee drinker, I've had a love/hate relationship with
            caffeine. The jitters were getting worse, I was painfully aware of
            the 3pm crash and the morning fog, and on top of all that, somewhere
            in my 40s the things I used to take for granted — energy, drive,
            focus — just weren't what they used to be. I blamed it on getting
            older.
          </p>
          <p style={{ marginBottom: 16 }}>
            Enter — my search for a new morning drink that could give me the
            same energy and focus coffee provides, but without any of the
            fallout. I wanted to sleep better, feel less wired, skip the crash,
            and honestly, I wanted to feel like myself again.
          </p>
          <p style={{ marginBottom: 16 }}>
            After a ton of research I honed in on mushroom coffee. I know —
            sounds gross, right? But after reading countless studies I decided I
            had to try it. So I tried all the best mushroom coffee brands
            (according to the internet) and I drank each one for 12 days
            straight, with a weekend off in between to reset my body and mind.
          </p>
          <p style={{ marginBottom: 16 }}>
            Here's the thing nobody warned me about: almost every one of them is
            the exact same idea — low-caffeine coffee with a pinch of mushrooms
            thrown in. Only <strong>one</strong> was actually built for a man's
            body. And the difference was night and day.
          </p>
          <p style={{ marginBottom: 0 }}>
            <strong>
              Here are my top 5 mushroom coffees for men on the market:
            </strong>
          </p>
        </div>
        ...
        <ProductSection
          ...
          pros={[
            {
              bold: 'The taste was a 10/10 for me. My favorite by far.',
              text: ' A rich, robust dark-roast flavor because the base is real organic Arabica coffee — and it was the only one where I couldn\'t taste the mushrooms or any of the extra ingredients they packed in. The only one that didn\'t feel like I was "giving up" coffee or sacrificing taste for the health benefits.',
            },
            {
            ...
            {
              bold: 'Clinical-dose mushrooms, not pixie dust.',
              text: " 1,000mg Lion's Mane and 1,000mg Cordyceps, plus Reishi and Chaga. My brain fog lifted in the first couple weeks and my gym stamina came back.",
            },
            {
              bold: '100% transparent label.',
              text: ' Every single dose is printed right there — no "proprietary blend" hiding how little you\'re actually getting. Once I saw how the others hide their numbers, I couldn\'t unsee it.',
            },
            {
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          >
            <strong>Balls & Brains by a landslide</strong> — and trust me, I{' '}
            <em>wanted</em> to hate it because of the name. I even did a blind
            taste test of my top 3 with my brother (who pulled espresso at a
            coffee shop for years) and my buddy who calls himself a coffee snob,
            and Balls & Brains was their #1 pick too.
          </p>
          <p
            style={{
              fontSize: 16,
          ...
          >
            Three months in, my energy, focus and drive are the best they've
            been since my 30s — and I'm not going back to regular coffee. It's
            the only one on this list that tastes like real coffee <em>and</em>{' '}
            was actually built for a man's body.
          </p>
          ...
          >
            ...
            <div style={{ background: '#fefdf5', padding: '20px 24px' }}>
              ...
              >
                {[
                  'Real coffee taste — rich, dark-roast Arabica',
                  'Clinically dosed for the male body (T-support, cortisol, focus)',
                  'All-day clean energy — no jitters, no 2pm crash',
                  '365-Day Money-Back Guarantee — the longest in the category',
                ].map((item, i) => (
                  <div
                    key={i}
                    style={{
              ...
              >
                Backed by a 365-Day Money-Back Guarantee · Free shipping · Made
                in the USA
              </p>
            </div>
          </div>
        ...
        >
          ...
          or prevent any disease. Individual results may vary. This article
          contains affiliate links — if you purchase through our links we may
          receive a commission at no additional cost to you. All products were
          independently purchased and evaluated.
        </p>
      </div>
    </div>
  );
